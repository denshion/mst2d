function [Csca] = CscaIntegrateScatteringAmplitude(ki, r_sca, a, l, Rint, gg_)
% CscaIntegrateScatteringAmplitude(ki, r_sca, a, l, Rint, [gg = 100])
%   Compute the scattering cross-section by integrating the scattering
